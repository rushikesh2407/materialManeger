...
public class ShortCloseTest extends TestBase {
	Receipt_Shortclose_Payment receipt_Shortclose_Payment;
	LoginPages loginPages;

	public ShortCloseTest() {
		super();
	}
	...
	@Test(priority = 1)
	public void ShortClose() throws InterruptedException, AWTException {
		loginPages.Login(prop.getProperty("username"), prop.getProperty("password"));
		loginPages.ValidateLogin();

	
		receipt_Shortclose_Payment.Shortclose();
